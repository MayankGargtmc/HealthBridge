...
SECRET_KEY = env('SECRET_KEY', default='django-insecure-healthbridge-hackathon-key-change-in-prod')
...
# Database
# Using SQLite for quick hackathon setup, can switch to PostgreSQL
DATABASES = {
    'default': {
...
# MongoDB settings for raw document storage
MONGODB_URI = env('MONGODB_URI', default='mongodb://localhost:27017/')
MONGODB_DB_NAME = env('MONGODB_DB_NAME', default='healthbridge')
...
REST_FRAMEWORK = {
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.AllowAny',  # Open for hackathon, add auth later
    ],
